...
extern int TX_XDP;             // -x forces AF_XDP zero-copy TX
...
typedef enum {
    ...
    HDR_TMPL_IFH_LA,  /* Internal frame header */
    HDR_TMPL_ETH,
    HDR_TMPL_CTAG,
    HDR_TMPL_STAG,
    HDR_TMPL_RTAG,
    ...
    HDR_TMPL_ICMP,
    HDR_TMPL_IGMP,
    HDR_TMPL_IGMPV3_GROUP,
    HDR_TMPL_MLD,
    HDR_TMPL_MLDV2_GROUP,
    HDR_TMPL_UDP,
    HDR_TMPL_TCP,
    HDR_TMPL_PAYLOAD,
    HDR_TMPL_PADDING,
    ...
    HDR_TMPL_OAM_RAPS,
    HDR_TMPL_TS_SYNC,
    HDR_TMPL_TS_FOLLOW_UP,
    HDR_TMPL_TS_REQUEST,
    HDR_TMPL_TS_RESPONSE,
    HDR_TMPL_TS_PEER_REQUEST,
    HDR_TMPL_TS_PEER_RESPONSE,
    HDR_TMPL_TS_PEER_RESPONSE_FOLLOW_UP,
    HDR_TMPL_TS_ANNOUNCE,
    HDR_TMPL_TS_TLV_ORG,
    HDR_TMPL_TS_TLV_PATH,
    HDR_TMPL_PNET_RTC,
    HDR_TMPL_OPC_UA,
    HDR_TMPL_PRP_RCT,
    HDR_TMPL_HSR_TAG,
...
typedef struct cmd {
    ...
    struct ef_xdp *xdp;        // AF_XDP zero-copy TX state, NULL if unused
